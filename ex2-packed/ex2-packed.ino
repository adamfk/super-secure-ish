...
//////////////////////////////////////////////////////////////////////////////////
// #pragma once
#include <pins_arduino.h> // for A0,1,2,3,4,... defines
...
public:
    ...
    void update(const uint32_t loop_delta_ms)
    {
        ...
        m_dispatch_fsm_event(ControllerSm::EventId::DO);
    }

    void arm()
    {
        m_dispatch_fsm_event(ControllerSm::EventId::ARM);
    }

    void disarm()
    {
        m_dispatch_fsm_event(ControllerSm::EventId::DISARM);
    }
...
protected:
    ...
    void m_dispatch_fsm_event(ControllerSm::EventId eventId)
    {
    ...
    // --------- ControllerSm interface implementation below ---------
